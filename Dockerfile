FROM python:3.9-slim
        #  Це середовище, яке необхідно для роботи нашого проекту - це сам Python.
        #  Це інструкція яка вказує Docker який базовий образ потрібно використовувати 
        #  для створення нового образу.
        #  В нашому випадку ми використовуємо офіційний образ Python версії 3.9 
        #  на базі легковагого (slim) дистрибутиву Linux.
        #  Цей образ вже містить встановлений Python і всі необхідні залежності 
        #  для його роботи.
        #  Використання легковагого образу допомагає зменшити розмір кінцевого 
        #  Docker-образу, що робить його більш ефективним для розгортання.
WORKDIR /app
